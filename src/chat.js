            ...
            <Grid item xs={9}>
                <List className={classes.messageArea}>
                    <ListItem key="1">
                        <Grid container>
                            <Grid item xs={12}>
                                <ListItemText align="right" primary="Hello World"></ListItemText>
                            </Grid>
                            <Grid item xs={12}>
                    ...
                    <ListItem key="2">
                        <Grid container>
                            <Grid item xs={12}>
                                <ListItemText align="left" primary="Hello Hello"></ListItemText>
                            </Grid>
                            <Grid item xs={12}>
                    ...
                    <ListItem key="3">
                        <Grid container>
                            <Grid item xs={12}>
                                <ListItemText align="right" primary="lorem ipsum"></ListItemText>
                            </Grid>
                            <Grid item xs={12}>
